...
import { ExamDto, UpdateExamDto, QueryExamIsApprovedDto } from './dto/ExamDto';

//Get all user's exams
export const getExams = async (input: QueryExamIsApprovedDto) => {
  try {
    const data = await ExamModel.find(input)
